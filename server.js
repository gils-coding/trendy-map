...
// 각 지점에서 반경 5km 검색 — 밀집 지역은 구 단위로 세분화
const BRAND_SEARCH_AREAS = [
  // 서울 한강 이남 (구별 세분화)
  { lat: 37.5172, lng: 127.0473 }, // 강남구
  { lat: 37.4837, lng: 127.0324 }, // 서초구
  { lat: 37.5145, lng: 127.1059 }, // 송파구
  { lat: 37.5301, lng: 127.1238 }, // 강동구
  { lat: 37.4784, lng: 126.9516 }, // 관악구
  { lat: 37.5124, lng: 126.9393 }, // 동작구
  { lat: 37.5264, lng: 126.8963 }, // 영등포구
  { lat: 37.4569, lng: 126.8955 }, // 금천구
  { lat: 37.4954, lng: 126.8875 }, // 구로구
  { lat: 37.5170, lng: 126.8667 }, // 양천구
  { lat: 37.5509, lng: 126.8495 }, // 강서구
  // 서울 한강 이북 (구별 세분화)
  { lat: 37.5638, lng: 126.9084 }, // 마포구
  { lat: 37.5791, lng: 126.9368 }, // 서대문구
  { lat: 37.5730, lng: 126.9794 }, // 종로구
  { lat: 37.5636, lng: 126.9817 }, // 중구
  { lat: 37.5384, lng: 126.9654 }, // 용산구
  { lat: 37.5634, lng: 127.0369 }, // 성동구
  { lat: 37.5384, lng: 127.0820 }, // 광진구
  { lat: 37.5744, lng: 127.0403 }, // 동대문구
  { lat: 37.6063, lng: 127.0927 }, // 중랑구
  { lat: 37.5894, lng: 127.0167 }, // 성북구
  { lat: 37.6026, lng: 126.9291 }, // 은평구
  { lat: 37.6396, lng: 127.0257 }, // 강북구
  { lat: 37.6688, lng: 127.0471 }, // 도봉구
  { lat: 37.6542, lng: 127.0568 }, // 노원구
  // 경기 남부
  { lat: 37.2636, lng: 127.0286 }, // 수원 팔달
  { lat: 37.2910, lng: 127.0089 }, // 수원 장안
  { lat: 37.2544, lng: 127.0431 }, // 수원 권선
  { lat: 37.2593, lng: 127.0645 }, // 수원 영통
  { lat: 37.3640, lng: 127.1092 }, // 성남 분당
  { lat: 37.4385, lng: 127.1378 }, // 성남 수정·중원
  { lat: 37.3233, lng: 127.0980 }, // 용인 수지
  { lat: 37.2754, lng: 127.1158 }, // 용인 기흥
  { lat: 37.2077, lng: 127.0739 }, // 화성 동탄
  { lat: 36.9944, lng: 127.0870 }, // 평택
  { lat: 37.3236, lng: 126.8310 }, // 안산
  { lat: 37.3942, lng: 126.9568 }, // 안양
  { lat: 37.3450, lng: 126.9333 }, // 군포·의왕
  { lat: 37.2785, lng: 127.4439 }, // 이천
  // 경기 북부·서부
  { lat: 37.5034, lng: 126.7660 }, // 부천
  { lat: 37.6596, lng: 126.8320 }, // 고양 일산
  { lat: 37.6959, lng: 126.7696 }, // 고양 덕양
  { lat: 37.7400, lng: 126.8693 }, // 파주
  { lat: 37.6541, lng: 127.0764 }, // 의정부
  { lat: 37.7298, lng: 127.0447 }, // 양주
  { lat: 37.4038, lng: 127.1171 }, // 하남·광주
  { lat: 37.5963, lng: 127.1295 }, // 구리·남양주
  { lat: 37.6559, lng: 127.2168 }, // 남양주 와부
  { lat: 37.4138, lng: 126.9929 }, // 과천·의왕
  { lat: 37.3943, lng: 126.8341 }, // 시흥
  // 인천 (구별)
  { lat: 37.4563, lng: 126.7052 }, // 인천 남동구
  { lat: 37.4757, lng: 126.6164 }, // 인천 서구
  { lat: 37.5244, lng: 126.6765 }, // 인천 계양구
  { lat: 37.4485, lng: 126.6981 }, // 인천 미추홀구
  { lat: 37.3945, lng: 126.6428 }, // 인천 연수구(송도)
  { lat: 37.4740, lng: 126.6496 }, // 인천 부평구
  // 부산 (구별)
  { lat: 35.1028, lng: 129.0327 }, // 부산 중구
  { lat: 35.1629, lng: 129.1636 }, // 해운대구
  { lat: 35.1944, lng: 129.0132 }, // 부산진구
  { lat: 35.1530, lng: 129.0598 }, // 동래구
  { lat: 35.1056, lng: 129.0222 }, // 남구
  { lat: 35.1984, lng: 128.9897 }, // 북구
  { lat: 35.0989, lng: 128.9741 }, // 사하구
  { lat: 35.2421, lng: 129.0927 }, // 기장군
  // 대구 (구별)
  { lat: 35.8714, lng: 128.6014 }, // 대구 북구
  { lat: 35.8688, lng: 128.6066 }, // 대구 중구
  { lat: 35.8534, lng: 128.5300 }, // 달서구
  { lat: 35.8263, lng: 128.7531 }, // 수성구
  { lat: 35.9067, lng: 128.6897 }, // 동구
  // 광주 (구별)
  { lat: 35.1595, lng: 126.8526 }, // 동구
  { lat: 35.1550, lng: 126.9057 }, // 북구
  { lat: 35.1444, lng: 126.8325 }, // 서구
  { lat: 35.1177, lng: 126.8928 }, // 남구
  { lat: 35.2078, lng: 126.8074 }, // 광산구
  // 대전 (구별)
  { lat: 36.3504, lng: 127.3845 }, // 서구
  { lat: 36.3219, lng: 127.4290 }, // 유성구
  { lat: 36.3480, lng: 127.4249 }, // 중구
  { lat: 36.3782, lng: 127.4031 }, // 동구
  // 울산
  { lat: 35.5384, lng: 129.3114 }, // 남구
  { lat: 35.5665, lng: 129.3239 }, // 중구
  { lat: 35.4437, lng: 129.1732 }, // 울주군
  // 세종
  { lat: 36.4801, lng: 127.2890 },
  // 충청
  { lat: 36.6424, lng: 127.4890 }, // 청주 상당
  { lat: 36.6372, lng: 127.4393 }, // 청주 흥덕
  { lat: 36.8065, lng: 127.1519 }, // 천안 동남
  { lat: 36.8260, lng: 127.1481 }, // 천안 서북
  { lat: 36.8000, lng: 127.5167 }, // 충주
  { lat: 36.4801, lng: 127.2890 }, // 세종
  // 전라
  { lat: 35.8219, lng: 127.1489 }, // 전주 완산
  { lat: 35.8219, lng: 127.1068 }, // 전주 덕진
  { lat: 34.9506, lng: 127.4875 }, // 순천
  { lat: 34.7604, lng: 127.6617 }, // 여수
  { lat: 34.8151, lng: 126.4631 }, // 목포
  { lat: 35.9667, lng: 126.9667 }, // 군산
  // 경상
  { lat: 35.2280, lng: 128.6811 }, // 창원 성산
  { lat: 35.1882, lng: 128.5770 }, // 창원 마산
  { lat: 36.0190, lng: 129.3435 }, // 포항
  { lat: 35.1800, lng: 128.1076 }, // 진주
  { lat: 36.1194, lng: 128.3445 }, // 구미
  { lat: 36.5684, lng: 128.7294 }, // 안동
  { lat: 35.5439, lng: 129.3119 }, // 울산 북구
  { lat: 35.6505, lng: 128.7490 }, // 경산
  { lat: 35.3318, lng: 129.0153 }, // 양산
  // 강원
  { lat: 37.8747, lng: 127.7342 }, // 춘천
  { lat: 37.3422, lng: 127.9202 }, // 원주
  { lat: 37.7519, lng: 128.8759 }, // 강릉
  { lat: 37.5104, lng: 130.2187 }, // 울릉도 (소수)
  // 제주
    ...
    for (let page = 1; page <= 3; page++) {
      try {
        const result = await axios.get('https://dapi.kakao.com/v2/local/search/keyword.json', {
          params: { query: brand, x: area.lng, y: area.lat, radius: 5000, page, size: 15 },
          headers: { Authorization: `KakaoAK ${KAKAO_REST_KEY}` },
        });
